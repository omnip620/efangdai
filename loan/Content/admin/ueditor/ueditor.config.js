...
(function () {
     ...
     */
    var URL = UEDITOR_HOME_URL || (function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","print","searchreplace","preview","help","fullscreen","pagebreak","insertimage","snapscreen","date","time","wordimage","map","anchor","blockquote","background","bold","italic","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","directionalityltr","directionalityrtl","indent","removeformat","formatmatch","autotypeset","customstyle","paragraph","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable"]]
