...
namespace Pan.DAL
{
	...
	public partial class Questions
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Questions"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Questions");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Questions ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Pan.Model.Questions GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,title,content from Questions ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Pan.Model.Questions DataRowToModel(DataRow row)
		{
			Pan.Model.Questions model=new Pan.Model.Questions();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Questions T ");
