...
namespace Pan.BLL
{
	...
	{
		private readonly Pan.DAL.Credit dal=new Pan.DAL.Credit();
		public Credit()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Pan.Model.Credit GetModelByCache(int id)
		{
			
			string CacheKey = "CreditModel-" + id;
			...
			return (Pan.Model.Credit)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Pan.Model.Credit> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Pan.Model.Credit> DataTableToList(DataTable dt)
		{
			List<Pan.Model.Credit> modelList = new List<Pan.Model.Credit>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Pan.Model.Credit model;
