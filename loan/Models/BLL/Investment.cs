...
namespace Pan.BLL
{
	...
	{
		private readonly Pan.DAL.Investment dal=new Pan.DAL.Investment();
		public Investment()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Pan.Model.Investment GetModelByCache(int id)
		{
			...
			return (Pan.Model.Investment)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Pan.Model.Investment> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Pan.Model.Investment> DataTableToList(DataTable dt)
		{
			List<Pan.Model.Investment> modelList = new List<Pan.Model.Investment>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Pan.Model.Investment model;
