...
namespace Pan.BLL
{
	...
	{
		private readonly Pan.DAL.Affiliate dal=new Pan.DAL.Affiliate();
		public Affiliate()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Pan.Model.Affiliate GetModelByCache(int id)
		{
			
			string CacheKey = "AffiliateModel-" + id;
			...
			return (Pan.Model.Affiliate)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Pan.Model.Affiliate> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Pan.Model.Affiliate> DataTableToList(DataTable dt)
		{
			List<Pan.Model.Affiliate> modelList = new List<Pan.Model.Affiliate>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Pan.Model.Affiliate model;
