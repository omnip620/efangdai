...
namespace Pan.BLL
{
	...
	{
		private readonly Pan.DAL.Feedback dal=new Pan.DAL.Feedback();
		public Feedback()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Pan.Model.Feedback GetModelByCache(int id)
		{
			...
			return (Pan.Model.Feedback)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Pan.Model.Feedback> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Pan.Model.Feedback> DataTableToList(DataTable dt)
		{
			List<Pan.Model.Feedback> modelList = new List<Pan.Model.Feedback>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Pan.Model.Feedback model;
