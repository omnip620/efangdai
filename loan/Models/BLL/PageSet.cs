...
namespace Pan.BLL
{
	...
	{
		private readonly Pan.DAL.PageSet dal=new Pan.DAL.PageSet();
		public PageSet()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Pan.Model.PageSet GetModelByCache(int id)
		{
			
			string CacheKey = "PageSetModel-" + id;
			...
			return (Pan.Model.PageSet)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Pan.Model.PageSet> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Pan.Model.PageSet> DataTableToList(DataTable dt)
		{
			List<Pan.Model.PageSet> modelList = new List<Pan.Model.PageSet>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Pan.Model.PageSet model;
